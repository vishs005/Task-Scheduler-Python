...
dataX = [chartTime(2008, 7, 1, 0, 0, 0), chartTime(2008, 7, 1, 2, 17, 2), chartTime(
    2008, 7, 1, 8, 5, 30), chartTime(2008, 7, 1, 10, 54, 10), chartTime(2008, 7, 1,
    15, 40, 0), chartTime(2008, 7, 1, 18, 22, 20), chartTime(2008, 7, 1, 22, 17, 14),
    chartTime(2008, 7, 2, 2, 55, 50), chartTime(2008, 7, 2, 8, 17, 14), chartTime(
    2008, 7, 2, 11, 55, 50), chartTime(2008, 7, 2, 13, 17, 14), chartTime(2008, 7, 2,
    17, 55, 50), chartTime(2008, 7, 2, 20, 17, 14), chartTime(2008, 7, 3, 0, 0, 0)]
...
c.setPlotArea(100, 30, 470, 120, -1, -1, Transparent).setGridColor(Transparent,
    0x888888, Transparent, c.dashLineColor(0xcccccc, DotLine))
