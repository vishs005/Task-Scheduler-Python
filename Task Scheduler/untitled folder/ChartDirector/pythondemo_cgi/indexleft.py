...
var charts = [
    ...
    ['', ""],
    ['', "Bar Charts"],
    ['simplebar.py', "Simple Bar Chart", 1],
    ['colorbar.py', "Multi-Color Bar Chart", 1],
    ...
    ['multiline.py', "Multi-Line Chart", 1],
    ...
    ['boxwhisker.py', "Box-Whisker Chart", 1],
    ['boxwhisker2.py', "Horizontal Box-Whisker Chart", 1],
    ...
    ['', ""],
    ['', "Meters/Dials/Guages"],
    ['semicirclemeter.py', "Semi-Circle Meter", 1],
    ['roundmeter.py', "Round Meter", 1],
    ['wideameter.py', "Wide Angular Meters", 6],
    ['squareameter.py', "Square Angular Meters", 4],
    ['multiameter.py', "Multi-Pointer Angular Meter", 1],
    ...
    ['trackbox.py', "Track Box with Legend", 0],
