...
layer.addDataSet(data0, 0xcf4040, "Users").setDataSymbol2(os.path.join(
    os.path.dirname(sys.argv[0]), "small_user.png"))

# Add the first line using small_computer.png as the symbol.
layer.addDataSet(data1, 0x40cf40, "Computers").setDataSymbol2(os.path.join(
    os.path.dirname(sys.argv[0]), "small_computer.png"))
