...
dataY = [4.7, 4.7, 6.6, 2.2, 4.7, 4.0, 4.0, 5.1, 4.5, 4.5, 6.8, 4.5, 4, 2.1, 3, 2.5,
    2.5, 3.1]
dataX = [chartTime(1999, 7, 1), chartTime(2000, 1, 1), chartTime(2000, 2, 1),
...
c.addScatterLayer(dataX, ArrayMath(dataY).selectEQZ(pointType, NoValue).result(),
...
c.addScatterLayer(dataX, ArrayMath(dataY).selectEQZ(ArrayMath(pointType).sub(1
...
c.addScatterLayer(dataX, ArrayMath(dataY).selectEQZ(ArrayMath(pointType).sub(2
