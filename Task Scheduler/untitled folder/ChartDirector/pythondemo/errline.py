...
c.addTitle(
    ...
    ).setBackground(0xdddddd, 0, glassEffect())
...
errLayer = c.addBoxWhiskerLayer(None, None, ArrayMath(data).add(errData).result(),
    ArrayMath(data).sub(errData).result(), data, Transparent, 0xbb6633)
