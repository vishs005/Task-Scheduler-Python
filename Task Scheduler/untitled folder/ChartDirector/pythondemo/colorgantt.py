...
startDate = [chartTime(2004, 8, 16), chartTime(2004, 10, 4), chartTime(2004, 8, 30),
    chartTime(2004, 9, 13), chartTime(2004, 9, 20), chartTime(2004, 9, 27),
    chartTime(2004, 10, 4), chartTime(2004, 10, 4), chartTime(2004, 10, 25),
    chartTime(2004, 11, 1), chartTime(2004, 10, 18), chartTime(2004, 11, 8)]
endDate = [chartTime(2004, 8, 30), chartTime(2004, 10, 18), chartTime(2004, 9, 13),
    chartTime(2004, 9, 27), chartTime(2004, 10, 4), chartTime(2004, 10, 11),
...
# and color.
c.addScatterLayer([1], [chartTime(2004, 9, 13)], "Milestone 1", Cross2Shape(), 13,
    0xffff00)
c.addScatterLayer([3], [chartTime(2004, 10, 4)], "Milestone 2", StarShape(5), 15,
    0xff00ff)
c.addScatterLayer([5], [chartTime(2004, 11, 8)], "Milestone 3", TriangleSymbol, 13,
    0xff9933)
