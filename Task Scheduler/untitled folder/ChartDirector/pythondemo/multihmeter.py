...
m.addText(148, 70, m.formatValue(value0, "2"), "arial.ttf", 8, 0x6666ff, BottomRight
    ).setBackground(0, 0, -1)
m.addText(193, 70, m.formatValue(value1, "2"), "arial.ttf", 8, 0x33ff33, BottomRight
    ).setBackground(0, 0, -1)
m.addText(238, 70, m.formatValue(value2, "2"), "arial.ttf", 8, 0xff3333, BottomRight
    ).setBackground(0, 0, -1)
