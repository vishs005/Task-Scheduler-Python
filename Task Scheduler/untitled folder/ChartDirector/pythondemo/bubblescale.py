...
c.addScatterLayer(dataX0, dataY0, "", CircleSymbol, 9, 0x80ff3333, 0x80ff3333
    ).setSymbolScale(dataZX0, XAxisScale, dataZY0, YAxisScale)
...
c.addScatterLayer(dataX1, dataY1, "", SquareSymbol, 9, 0x803333ff, 0x803333ff
    ).setSymbolScale(dataZX1, XAxisScale, dataZY1, YAxisScale)
...
c.addScatterLayer(dataX2, dataY2, "", DiamondSymbol, 9, 0x8033ff33, 0x8033ff33
    ).setSymbolScale(dataZX2, XAxisScale, dataZY2, YAxisScale)
